...
import authRD, {setAuthUserDataThunkCreator, toLogout} from "../../Redux/auth-reducer";
...
export default connect(mapStateToProps, {setAuthUserDataThunkCreator, toLogout})(HeaderContainer);